"""
Storing the available properties and their units.
"""

GROUP_PROPERTIES = {
    "dc": "comoving distance [Mpc/h].",
    "dec": "declination [deg].",
    "flag": "0=complete; >0 truncated.",
    "id_halo_sam": "Galaxy parent halo ID in the SAM.",
    "mvir": "Viral mass of group [Msun/h].",
    "n_galaxies_selected": "number of galaxies that live in the same group and are present in the mock catalogue",
    "n_galaxies_total": "Total number of galaxies that live in the same group.",
    "ra": "Right Ascension [deg]",
    "sigma_3d_all": "Intrinsic 3D velocity dispersion of all galaxies in group [km/s]",
    "sigma_los_detected": "line-of-sight velocity dispersion of selected galaxies [km/s]",
    "snapshot": "Snapshot ID",
    "subvolume": "subvolume index",
    "tile": "Tile ID.",
    "vpec_r": "line-of-sight peculiar velocity [proper km/s].",
    "vpec_x": "x-component of peculiar velocity [proper km/s].",
    "vpec_y": "y-component of peculiar velocity [proper km/s].",
    "vpec_z": "z-component of peculiar velocity [proper km/s].",
    "zcmb": "Redshift in CMB frame.",
    "zcos": "Cosmological redshift without peculiar motions.",
    "zobs": "redshift in the observer-frame",
}
